...
package envdriverprobe

import "github.com/stephrobert/feint/internal/core/emulator"

// The value every pack held before #511: `Machines machine.Driver` was a
// public field of the environment, and `p.env.Machines` was how three packs
// built their bindings.
var _ = emulator.Env{}.Machines
