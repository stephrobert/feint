...
// The sentence of #514's acceptance criterion (a), verbatim. On 154c204 this
// file compiled and `go build ./internal/providers/scaleway/` exited 0, which
// is what left the boundary held by a convention plus an AST scan.
