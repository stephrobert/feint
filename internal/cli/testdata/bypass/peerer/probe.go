...
// The peering half. Outscale reached it directly as a second writer, and the
// audit measured a peering severed on CreateSubnet because of it.
var _ machine.Peerer
