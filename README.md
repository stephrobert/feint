...
Version **0.3.2**, named rather than fetched as `latest`: a mutable reference
...
```bash
base=https://github.com/stephrobert/feint/releases/download/v0.3.2
...
```bash
gh release download v0.3.2 --repo stephrobert/feint --pattern 'feint-linux-amd64'
