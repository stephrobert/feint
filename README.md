...
Version **0.5.0**, named rather than fetched as `latest`: a mutable reference
...
```bash
base=https://github.com/stephrobert/feint/releases/download/v0.5.0
...
```bash
gh release download v0.5.0 --repo stephrobert/feint --pattern 'feint-linux-amd64'
...
104 routes are mounted across the three packs. The tables count *upstream operations*
...
31 routes mounted, 11% of the measured upstream surface served.
...
16 routes mounted, 4% of the measured upstream surface served.

| Product | Served | Declined | Untriaged | Upstream |
|---|--:|--:|--:|--:|
| `exoscale` | 16 | 248 | 108 | 372 |
| **Total** | **16** | **248** | **108** | **372** |
