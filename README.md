...
>
> **Not proven**: quotas, prices, real capacity, identifier validation, authentication, eventual consistency. The 34 sections of [docs/limits.md](docs/limits.md) each say what one costs. An emulator with a single implicit account and no price list would have to invent those figures, and somebody would act on them.
>
...
285 routes are mounted across the three packs. The tables count *upstream operations*
...
107 routes mounted. Of the 315 operations upstream declares: 33% served,
66% declined on purpose, 0% untriaged.

| Group | Served | Declined | Untriaged | Upstream |
|---|--:|--:|--:|--:|
| `instance` | 53 | 97 | 0 | 150 |
| `iam` | 5 | 78 | 0 | 83 |
| `vpc` | 17 | 20 | 0 | 37 |
| `block` | 22 | 5 | 0 | 27 |
| `ipam` | 9 | 1 | 0 | 10 |
