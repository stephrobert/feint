...
>
> **Not proven**: quotas, prices, real capacity, identifier validation, authentication, eventual consistency. The 41 sections of [docs/limits.md](docs/limits.md) each say what one costs. An emulator with a single implicit account and no price list would have to invent those figures, and somebody would act on them.
>
...
370 routes are mounted across the three packs. The tables count *upstream operations*
...
173 routes mounted. Of the 486 operations upstream declares: 35% served,
