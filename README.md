...
397 routes are mounted across the three packs. The tables count *upstream operations*
...
193 routes mounted. Of the 536 operations upstream declares: 36% served,
63% declined on purpose, 0% untriaged.

| Group | Served | Declined | Untriaged | Upstream |
|---|--:|--:|--:|--:|
| `instance` | 72 | 79 | 0 | 151 |
| `lb` | 43 | 64 | 0 | 107 |
| `iam` | 5 | 78 | 0 | 83 |
| `vpcgw` | 15 | 49 | 0 | 64 |
| `baremetal` | 2 | 35 | 0 | 37 |
