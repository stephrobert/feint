...
371 routes are mounted across the three packs. The tables count *upstream operations*
...
174 routes mounted. Of the 486 operations upstream declares: 35% served,
64% declined on purpose, 0% untriaged.

| Group | Served | Declined | Untriaged | Upstream |
|---|--:|--:|--:|--:|
| `instance` | 68 | 82 | 0 | 150 |
| `lb` | 35 | 72 | 0 | 107 |
| `iam` | 5 | 78 | 0 | 83 |
| `vpcgw` | 15 | 49 | 0 | 64 |
| `vpc` | 19 | 18 | 0 | 37 |
