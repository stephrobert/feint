...
359 routes across 3 packs. Every route names the upstream operation it
...
| `DELETE` | `/vpc-gw/v2/zones/{zone}/ips/{ipID}` | `vpcgw/v2/API.DeleteIP` | `client` `runtime` |
...
### Served, and driven by no client (15)
