...
240 routes across 3 packs. Every route names the upstream operation it
...
| Method | Path | Upstream operation | Proven by |
|---|---|---|---|
| `POST` | `/api/v1/AcceptNetPeering` | `osc/Client.AcceptNetPeering` | — |
| `POST` | `/api/v1/CreateNetPeering` | `osc/Client.CreateNetPeering` | — |
| `POST` | `/api/v1/DeleteNetPeering` | `osc/Client.DeleteNetPeering` | — |
| `POST` | `/api/v1/ReadNetPeerings` | `osc/Client.ReadNetPeerings` | — |
| `POST` | `/api/v1/RejectNetPeering` | `osc/Client.RejectNetPeering` | — |
