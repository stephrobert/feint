...
393 operations served across 3 packs, counted from the record of the last
...
| Scaleway | 189 | 96 % (182) | 98 % (186) | 100 % (189) | 96 % (182) | 53 % (100) | 90 % (171) | 75 % (141) |
| **All three** | 393 | 94 % (368) | 97 % (382) | 98 % (384) | 94 % (368) | 58 % (227) | 86 % (338) | 63 % (249) |
...
| Method | Path | Upstream operation | Proven by |
|---|---|---|---|
| `GET` | `/baremetal/v1/zones/{zone}/offers` | `baremetal/v1/API.ListOffers` | — |
| `GET` | `/baremetal/v1/zones/{zone}/servers` | `baremetal/v1/API.ListServers` | — |
