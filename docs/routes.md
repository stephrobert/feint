...
139 routes across 3 packs. Every route names the upstream operation it
...
| Method | Path | Upstream operation |
|---|---|---|
| `POST` | `/api/v1/CreateInternetService` | `osc/Client.CreateInternetService` |
| `POST` | `/api/v1/CreateKeypair` | `osc/Client.CreateKeypair` |
| `POST` | `/api/v1/CreateNatService` | `osc/Client.CreateNatService` |
| `POST` | `/api/v1/CreateNet` | `osc/Client.CreateNet` |
| `POST` | `/api/v1/CreateNic` | `osc/Client.CreateNic` |
| `POST` | `/api/v1/CreatePublicIp` | `osc/Client.CreatePublicIp` |
| `POST` | `/api/v1/CreateRouteTable` | `osc/Client.CreateRouteTable` |
| `POST` | `/api/v1/CreateRoute` | `osc/Client.CreateRoute` |
| `POST` | `/api/v1/CreateSecurityGroupRule` | `osc/Client.CreateSecurityGroupRule` |
| `POST` | `/api/v1/CreateSecurityGroup` | `osc/Client.CreateSecurityGroup` |
| `POST` | `/api/v1/CreateSnapshot` | `osc/Client.CreateSnapshot` |
| `POST` | `/api/v1/CreateSubnet` | `osc/Client.CreateSubnet` |
| `POST` | `/api/v1/CreateTags` | `osc/Client.CreateTags` |
| `POST` | `/api/v1/CreateVms` | `osc/Client.CreateVms` |
| `POST` | `/api/v1/CreateVolume` | `osc/Client.CreateVolume` |
| `POST` | `/api/v1/DeleteInternetService` | `osc/Client.DeleteInternetService` |
| `POST` | `/api/v1/DeleteKeypair` | `osc/Client.DeleteKeypair` |
| `POST` | `/api/v1/DeleteNatService` | `osc/Client.DeleteNatService` |
| `POST` | `/api/v1/DeleteNet` | `osc/Client.DeleteNet` |
| `POST` | `/api/v1/DeleteNic` | `osc/Client.DeleteNic` |
| `POST` | `/api/v1/DeletePublicIp` | `osc/Client.DeletePublicIp` |
| `POST` | `/api/v1/DeleteRouteTable` | `osc/Client.DeleteRouteTable` |
| `POST` | `/api/v1/DeleteRoute` | `osc/Client.DeleteRoute` |
| `POST` | `/api/v1/DeleteSecurityGroupRule` | `osc/Client.DeleteSecurityGroupRule` |
| `POST` | `/api/v1/DeleteSecurityGroup` | `osc/Client.DeleteSecurityGroup` |
| `POST` | `/api/v1/DeleteSnapshot` | `osc/Client.DeleteSnapshot` |
| `POST` | `/api/v1/DeleteSubnet` | `osc/Client.DeleteSubnet` |
| `POST` | `/api/v1/DeleteTags` | `osc/Client.DeleteTags` |
| `POST` | `/api/v1/DeleteVms` | `osc/Client.DeleteVms` |
| `POST` | `/api/v1/DeleteVolume` | `osc/Client.DeleteVolume` |
| `POST` | `/api/v1/LinkInternetService` | `osc/Client.LinkInternetService` |
| `POST` | `/api/v1/LinkNic` | `osc/Client.LinkNic` |
| `POST` | `/api/v1/LinkRouteTable` | `osc/Client.LinkRouteTable` |
| `POST` | `/api/v1/LinkVolume` | `osc/Client.LinkVolume` |
| `POST` | `/api/v1/ReadAdminPassword` | `osc/Client.ReadAdminPassword` |
| `POST` | `/api/v1/ReadDhcpOptions` | `osc/Client.ReadDhcpOptions` |
| `POST` | `/api/v1/ReadImages` | `osc/Client.ReadImages` |
| `POST` | `/api/v1/ReadInternetServices` | `osc/Client.ReadInternetServices` |
| `POST` | `/api/v1/ReadKeypairs` | `osc/Client.ReadKeypairs` |
| `POST` | `/api/v1/ReadNatServices` | `osc/Client.ReadNatServices` |
| `POST` | `/api/v1/ReadNetAccessPointServices` | `osc/Client.ReadNetAccessPointServices` |
| `POST` | `/api/v1/ReadNets` | `osc/Client.ReadNets` |
| `POST` | `/api/v1/ReadNics` | `osc/Client.ReadNics` |
| `POST` | `/api/v1/ReadPublicIpRanges` | `osc/Client.ReadPublicIpRanges` |
| `POST` | `/api/v1/ReadPublicIps` | `osc/Client.ReadPublicIps` |
| `POST` | `/api/v1/ReadRegions` | `osc/Client.ReadRegions` |
| `POST` | `/api/v1/ReadRouteTables` | `osc/Client.ReadRouteTables` |
| `POST` | `/api/v1/ReadSecurityGroups` | `osc/Client.ReadSecurityGroups` |
| `POST` | `/api/v1/ReadSnapshots` | `osc/Client.ReadSnapshots` |
| `POST` | `/api/v1/ReadSubnets` | `osc/Client.ReadSubnets` |
| `POST` | `/api/v1/ReadSubregions` | `osc/Client.ReadSubregions` |
| `POST` | `/api/v1/ReadTags` | `osc/Client.ReadTags` |
| `POST` | `/api/v1/ReadVmTypes` | `osc/Client.ReadVmTypes` |
| `POST` | `/api/v1/ReadVmsState` | `osc/Client.ReadVmsState` |
| `POST` | `/api/v1/ReadVms` | `osc/Client.ReadVms` |
| `POST` | `/api/v1/ReadVolumes` | `osc/Client.ReadVolumes` |
| `POST` | `/api/v1/RebootVms` | `osc/Client.RebootVms` |
| `POST` | `/api/v1/StartVms` | `osc/Client.StartVms` |
| `POST` | `/api/v1/StopVms` | `osc/Client.StopVms` |
| `POST` | `/api/v1/UnlinkInternetService` | `osc/Client.UnlinkInternetService` |
| `POST` | `/api/v1/UnlinkNic` | `osc/Client.UnlinkNic` |
| `POST` | `/api/v1/UnlinkRouteTable` | `osc/Client.UnlinkRouteTable` |
| `POST` | `/api/v1/UnlinkVolume` | `osc/Client.UnlinkVolume` |
| `POST` | `/api/v1/UpdateRoute` | `osc/Client.UpdateRoute` |
| `POST` | `/api/v1/UpdateVm` | `osc/Client.UpdateVm` |
| `POST` | `/api/v1/UpdateVolume` | `osc/Client.UpdateVolume` |
...
- `osc/Client.CreateListenerRule` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
- `osc/Client.CreateLoadBalancer` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
- `osc/Client.CreateLoadBalancerListeners` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
- `osc/Client.CreateLoadBalancerPolicy` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
- `osc/Client.CreateLoadBalancerTags` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.CreateServerCertificate` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.DeleteListenerRule` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
- `osc/Client.DeleteLoadBalancer` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
- `osc/Client.DeleteLoadBalancerListeners` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
- `osc/Client.DeleteLoadBalancerPolicy` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
- `osc/Client.DeleteLoadBalancerTags` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.DeleteServerCertificate` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.DeregisterVmsInLoadBalancer` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.LinkLoadBalancerBackendMachines` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.LinkPublicIp` — publishing an address on a machine is the runtime's job, and a link stamping an address the interface does not carry would make ReadVms describe connectivity that does not exist
...
- `osc/Client.ReadListenerRules` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
- `osc/Client.ReadLoadBalancerTags` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
- `osc/Client.ReadLoadBalancers` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.ReadServerCertificates` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.ReadVmsHealth` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.RegisterVmsInLoadBalancer` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.UnlinkLoadBalancerBackendMachines` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.UnlinkPublicIp` — publishing an address on a machine is the runtime's job, and a link stamping an address the interface does not carry would make ReadVms describe connectivity that does not exist
...
- `osc/Client.UpdateListenerRule` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
- `osc/Client.UpdateLoadBalancer` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
- `osc/Client.UpdateServerCertificate` — a load balancer is a data plane accepting real connections, and the emulator has none: a control plane alone would hand out a DNS name resolving nowhere and a backend health nobody measured
...
| `GET` | `/v2/quota` | `exoscale/v2.list-quotas` |
