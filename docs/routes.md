...
357 routes across 3 packs. Every route names the upstream operation it
...
- `Listener` — 6 operations — no surveyed stack calls these: the measured lifecycle is create, read, update, register/unlink, delete (#281) — and a backend health nothing probed would be an invented answer
- `LoadBalancer` — 5 operations — no surveyed stack calls these: the measured lifecycle is create, read, update, register/unlink, delete (#281) — and a backend health nothing probed would be an invented answer
- `LoadBalancerPolicy` — 2 operations — no surveyed stack calls these: the measured lifecycle is create, read, update, register/unlink, delete (#281) — and a backend health nothing probed would be an invented answer
...
- `ServerCertificate` — 4 operations — no surveyed stack calls these: the measured lifecycle is create, read, update, register/unlink, delete (#281) — and a backend health nothing probed would be an invented answer
