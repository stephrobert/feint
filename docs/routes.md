...
| `DELETE` | `/block/v1/zones/{zone}/volumes/{id}` | `block/v1/API.DeleteVolume` |
| `DELETE` | `/block/v1alpha1/zones/{zone}/snapshots/{id}` | `block/v1alpha1/API.DeleteSnapshot` |
| `DELETE` | `/block/v1alpha1/zones/{zone}/volumes/{id}` | `block/v1alpha1/API.DeleteVolume` |
| `GET` | `/block/v1/zones/{zone}/snapshots/{id}` | `block/v1/API.GetSnapshot` |
| `GET` | `/block/v1/zones/{zone}/snapshots` | `block/v1/API.ListSnapshots` |
| `GET` | `/block/v1/zones/{zone}/volume-types` | `block/v1/API.ListVolumeTypes` |
| `GET` | `/block/v1/zones/{zone}/volumes/{id}` | `block/v1/API.GetVolume` |
| `GET` | `/block/v1/zones/{zone}/volumes` | `block/v1/API.ListVolumes` |
| `GET` | `/block/v1alpha1/zones/{zone}/snapshots/{id}` | `block/v1alpha1/API.GetSnapshot` |
| `GET` | `/block/v1alpha1/zones/{zone}/snapshots` | `block/v1alpha1/API.ListSnapshots` |
| `GET` | `/block/v1alpha1/zones/{zone}/volume-types` | `block/v1alpha1/API.ListVolumeTypes` |
| `GET` | `/block/v1alpha1/zones/{zone}/volumes/{id}` | `block/v1alpha1/API.GetVolume` |
| `GET` | `/block/v1alpha1/zones/{zone}/volumes` | `block/v1alpha1/API.ListVolumes` |
| `PATCH` | `/block/v1/zones/{zone}/snapshots/{id}` | `block/v1/API.UpdateSnapshot` |
| `PATCH` | `/block/v1/zones/{zone}/volumes/{id}` | `block/v1/API.UpdateVolume` |
| `PATCH` | `/block/v1alpha1/zones/{zone}/snapshots/{id}` | `block/v1alpha1/API.UpdateSnapshot` |
| `PATCH` | `/block/v1alpha1/zones/{zone}/volumes/{id}` | `block/v1alpha1/API.UpdateVolume` |
| `POST` | `/block/v1/zones/{zone}/snapshots` | `block/v1/API.CreateSnapshot` |
| `POST` | `/block/v1/zones/{zone}/volumes` | `block/v1/API.CreateVolume` |
| `POST` | `/block/v1alpha1/zones/{zone}/snapshots` | `block/v1alpha1/API.CreateSnapshot` |
| `POST` | `/block/v1alpha1/zones/{zone}/volumes` | `block/v1alpha1/API.CreateVolume` |
...
| Method | Path | Upstream operation |
|---|---|---|
| `DELETE` | `/instance/v1/zones/{zone}/images/{id}` | `instance/v1/API.DeleteImage` |
...
| `DELETE` | `/instance/v1/zones/{zone}/snapshots/{id}` | `instance/v1/API.DeleteSnapshot` |
...
| `GET` | `/instance/v1/zones/{zone}/images` | `instance/v1/API.ListImages` |
...
| `GET` | `/instance/v1/zones/{zone}/snapshots/{id}` | `instance/v1/API.GetSnapshot` |
| `GET` | `/instance/v1/zones/{zone}/snapshots` | `instance/v1/API.ListSnapshots` |
...
| `PATCH` | `/instance/v1/zones/{zone}/images/{id}` | `instance/v1/API.UpdateImage` |
...
| `PATCH` | `/instance/v1/zones/{zone}/snapshots/{id}` | `instance/v1/API.UpdateSnapshot` |
| `PATCH` | `/instance/v1/zones/{zone}/volumes/{id}` | `instance/v1/API.UpdateVolume` |
| `POST` | `/instance/v1/zones/{zone}/images` | `instance/v1/API.CreateImage` |
...
| `POST` | `/instance/v1/zones/{zone}/snapshots` | `instance/v1/API.CreateSnapshot` |
...
| Method | Path | Upstream operation |
|---|---|---|
| `POST` | `/api/v1/CreateImage` | `osc/Client.CreateImage` |
...
| `POST` | `/api/v1/DeleteImage` | `osc/Client.DeleteImage` |
...
| `POST` | `/api/v1/LinkPublicIp` | `osc/Client.LinkPublicIp` |
...
| `POST` | `/api/v1/ReadLoadBalancers` | `osc/Client.ReadLoadBalancers` |
...
| Method | Path | Upstream operation |
|---|---|---|
| `DELETE` | `/v2/anti-affinity-group/{id}` | `exoscale/v2.delete-anti-affinity-group` |
| `DELETE` | `/v2/elastic-ip/{id}` | `exoscale/v2.delete-elastic-ip` |
| `DELETE` | `/v2/instance/{id}` | `exoscale/v2.delete-instance` |
| `DELETE` | `/v2/security-group/{id}/rules/{rule}` | `exoscale/v2.delete-rule-from-security-group` |
| `DELETE` | `/v2/security-group/{id}` | `exoscale/v2.delete-security-group` |
| `DELETE` | `/v2/ssh-key/{name}` | `exoscale/v2.delete-ssh-key` |
| `GET` | `/v2/anti-affinity-group/{id}` | `exoscale/v2.get-anti-affinity-group` |
| `GET` | `/v2/anti-affinity-group` | `exoscale/v2.list-anti-affinity-groups` |
| `GET` | `/v2/deploy-target/{id}` | `exoscale/v2.get-deploy-target` |
| `GET` | `/v2/deploy-target` | `exoscale/v2.list-deploy-targets` |
| `GET` | `/v2/elastic-ip/{id}` | `exoscale/v2.get-elastic-ip` |
| `GET` | `/v2/elastic-ip` | `exoscale/v2.list-elastic-ips` |
...
| `GET` | `/v2/security-group/{id}` | `exoscale/v2.get-security-group` |
| `GET` | `/v2/security-group` | `exoscale/v2.list-security-groups` |
...
| `POST` | `/v2/anti-affinity-group` | `exoscale/v2.create-anti-affinity-group` |
| `POST` | `/v2/elastic-ip` | `exoscale/v2.create-elastic-ip` |
| `POST` | `/v2/instance` | `exoscale/v2.create-instance` |
| `POST` | `/v2/security-group/{id}/rules` | `exoscale/v2.add-rule-to-security-group` |
| `POST` | `/v2/security-group` | `exoscale/v2.create-security-group` |
| `POST` | `/v2/ssh-key` | `exoscale/v2.register-ssh-key` |
| `PUT` | `/v2/elastic-ip/{id}:attach` | `exoscale/v2.attach-instance-to-elastic-ip` |
| `PUT` | `/v2/elastic-ip/{id}:detach` | `exoscale/v2.detach-instance-from-elastic-ip` |
| `PUT` | `/v2/elastic-ip/{id}` | `exoscale/v2.update-elastic-ip` |
| `PUT` | `/v2/instance/{id}:add-protection` | `exoscale/v2.add-instance-protection` |
| `PUT` | `/v2/instance/{id}:reboot` | `exoscale/v2.reboot-instance` |
| `PUT` | `/v2/instance/{id}:remove-protection` | `exoscale/v2.remove-instance-protection` |
| `PUT` | `/v2/instance/{id}:reset` | `exoscale/v2.reset-instance` |
| `PUT` | `/v2/instance/{id}:resize-disk` | `exoscale/v2.resize-instance-disk` |
| `PUT` | `/v2/instance/{id}:scale` | `exoscale/v2.scale-instance` |
| `PUT` | `/v2/instance/{id}:start` | `exoscale/v2.start-instance` |
| `PUT` | `/v2/instance/{id}:stop` | `exoscale/v2.stop-instance` |
| `PUT` | `/v2/instance/{id}` | `exoscale/v2.update-instance` |
