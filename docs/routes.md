...
395 operations served across 3 packs, counted from the record of the last
...
| Outscale | 100 | 100 % (100) | 100 % (100) | 100 % (100) | 100 % (100) | 94 % (94) | 89 % (89) | 90 % (90) |
| Scaleway | 191 | 96 % (184) | 98 % (188) | 100 % (191) | 96 % (184) | 52 % (100) | 90 % (171) | 74 % (141) |
| **All three** | 395 | 95 % (375) | 97 % (384) | 98 % (387) | 95 % (375) | 57 % (227) | 87 % (343) | 63 % (249) |
...
be closed on it. So the 17 % and the 90 % at the two ends of that column are
...
397 routes across 3 packs. Every route names the upstream operation it
...
| Method | Path | Upstream operation | Proven by |
|---|---|---|---|
| `POST` | `/api/v1/CreateFlexibleGpu` | `osc/Client.CreateFlexibleGpu` | `client` `contract` `runtime` `probe` `behaviour` |
| `POST` | `/api/v1/DeleteFlexibleGpu` | `osc/Client.DeleteFlexibleGpu` | `client` `contract` `runtime` `probe` `behaviour` |
| `POST` | `/api/v1/LinkFlexibleGpu` | `osc/Client.LinkFlexibleGpu` | `client` `contract` `runtime` `probe` `behaviour` |
...
| `POST` | `/api/v1/UnlinkFlexibleGpu` | `osc/Client.UnlinkFlexibleGpu` | `client` `contract` `runtime` `probe` `behaviour` |
| `POST` | `/api/v1/UpdateFlexibleGpu` | `osc/Client.UpdateFlexibleGpu` | `client` `contract` `runtime` `probe` `behaviour` |
