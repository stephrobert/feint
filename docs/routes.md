...
231 routes across 3 packs. Every route names the upstream operation it
...
| `POST` | `/vpc/v2/regions/{region}/routes` | `vpc/v2/API.CreateRoute` | `client` `contract` `probe` |
...
| `DELETE` | `/v2/private-network/{id}` | `exoscale/v2.delete-private-network` | `client` `contract` `probe` `behaviour` `negative` |
...
| `GET` | `/v2/private-network/{id}` | `exoscale/v2.get-private-network` | `client` `contract` `probe` `behaviour` |
| `GET` | `/v2/private-network` | `exoscale/v2.list-private-networks` | `client` `contract` `shape` `probe` `behaviour` |
...
| `POST` | `/v2/private-network` | `exoscale/v2.create-private-network` | `client` `contract` `probe` `behaviour` |
...
| `PUT` | `/v2/private-network/{id}:attach` | `exoscale/v2.attach-instance-to-private-network` | `client` `contract` `probe` `behaviour` |
| `PUT` | `/v2/private-network/{id}:detach` | `exoscale/v2.detach-instance-from-private-network` | `client` `contract` `probe` `behaviour` |
| `PUT` | `/v2/private-network/{id}:update-ip` | `exoscale/v2.update-private-network-instance-ip` | `client` `contract` `probe` `behaviour` `negative` |
| `PUT` | `/v2/private-network/{id}` | `exoscale/v2.update-private-network` | `probe` |
| `PUT` | `/v2/security-group/{id}:add-source` | `exoscale/v2.add-external-source-to-security-group` | `client` `contract` `probe` `behaviour` |
...
| `PUT` | `/v2/security-group/{id}:remove-source` | `exoscale/v2.remove-external-source-from-security-group` | `client` `contract` `probe` `behaviour` |
