...
Version **0.2.0**, named rather than fetched as `latest`: a mutable reference
...
```bash
base=https://github.com/stephrobert/feint/releases/download/v0.2.0
...
```bash
gh release download v0.2.0 --repo stephrobert/feint --pattern 'feint-linux-amd64'
