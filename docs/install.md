...
```bash
docker run --rm -p 127.0.0.1:4599:4599 ghcr.io/stephrobert/feint:v0.8.0
...
```yaml
services:
  - name: ghcr.io/stephrobert/feint:v0.8.0
    alias: feint
```
...
gh attestation verify oci://ghcr.io/stephrobert/feint:v0.8.0 \
