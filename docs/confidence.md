...
per operation and generated: [routes.md](routes.md) prints what each of the 272
mounted operations has earned, and [`coverage/evidence.json`](../coverage/evidence.json)
is the record it prints.

<!-- confidence:start -->
<!-- Generated by `mise run docs:coverage`. Do not edit by hand. -->

**272 operations mounted, 254 driven by a real client** in the recorded run. The
18 that are not each state why at their route, and [routes.md](routes.md)
